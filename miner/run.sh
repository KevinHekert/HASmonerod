...
bashio::log.info "exec /xmrig/build/xmrig -o $SERVER -u $WALLET -t $CORES -k --coin monero -p $WORKER"
exec /xmrig/build/xmrig -o $SERVER -u $WALLET -t $CORES -k --coin monero -p $WORKER